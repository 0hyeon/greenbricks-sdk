...
declare function sendTrackingData1(name: string, event: string, sex: string, type: string, adid: string): Promise<any>;
...
declare const curriedSendTrackingData: (a: string) => (b: string) => (c: string) => (d: string) => (e: string) => Promise<any>;
